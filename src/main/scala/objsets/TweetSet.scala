...
class Empty extends TweetSet {
  ...
  def mostRetweeted: Tweet = throw new java.util.NoSuchElementException("mostRetweeted of Empty TweetSet")
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    if (left.isInstanceOf[Empty] && right.isInstanceOf[Empty]) {
      ...
      val rightMostRetweeted: Tweet = right.mostRetweeted
      if (elem.retweets > rightMostRetweeted.retweets) {
        elem
      } else {
        rightMostRetweeted
      }
      ...
      val leftMostRetweeted: Tweet = left.mostRetweeted
      if (elem.retweets > leftMostRetweeted.retweets) {
        elem
      } else {
        leftMostRetweeted
      }
      ...
      val leftMostRetweeted: Tweet = left.mostRetweeted
      val rightMostRetweeted: Tweet = right.mostRetweeted
      val leftOrRightMostRetweeted: Tweet = if (leftMostRetweeted.retweets > rightMostRetweeted.retweets) leftMostRetweeted else rightMostRetweeted
      if (elem.retweets > leftOrRightMostRetweeted.retweets) elem else leftOrRightMostRetweeted
    }
